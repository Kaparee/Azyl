...
<a {{ $attributes->merge(['class' => $classes]) }}>
    <svg class="w-5 h-5 opacity-80 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        @elseif($icon == 'paw')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14v2M8.5 8.5a2 2 0 11-4 0 2 2 0 014 0zM15.5 8.5a2 2 0 11-4 0 2 2 0 014 0zM12 5.5a2 2 0 11-4 0 2 2 0 014 0zM6.5 12a2 2 0 11-4 0 2 2 0 014 0zM17.5 12a2 2 0 11-4 0 2 2 0 014 0z" />
        @elseif($icon == 'heart')
        ...
        @elseif($icon == 'stethoscope')
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11v1a7 7 0 01-14 0v-1m14 0a3 3 0 00-6 0v1a1 1 0 01-2 0v-1a3 3 0 00-6 0m6-6a3 3 0 016 0v2m-6-2a3 3 0 00-6 0v2m16 8v-2a2 2 0 00-2-2h-1m-10 4v-2a2 2 0 00-2-2H4" />
