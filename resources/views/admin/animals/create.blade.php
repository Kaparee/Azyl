            ...
            <form method="POST" action="{{ route('admin.animals.store') }}" class="p-6" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="age_months" value="{{ old('age_months') }}" class="w-full rounded-xl border-slate-200" placeholder="np. 36" required min="0" max="360">
                    ...
                    <div>
                        ...
                        <input type="number" name="height" value="{{ old('height') }}" class="w-full rounded-xl border-slate-200" placeholder="np. 45" required min="1" max="300">
                    ...
                    <div>
                        ...
                        <input type="date" name="arrival_date" value="{{ old('arrival_date', now()->format('Y-m-d')) }}" class="w-full rounded-xl border-slate-200" required max="{{ date('Y-m-d') }}">
                        @error('arrival_date') <p class="text-red-600 text-sm">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-sm mb-1">Opłata adopcyjna *</label>
                        <input type="number" step="0.01" name="adoption_fee" value="{{ old('adoption_fee', 0) }}" class="w-full rounded-xl border-slate-200" required min="0">
